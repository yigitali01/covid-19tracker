...
public class Constants {
    ...
    public static final String COUNTRY_CRITICAL = "critical";
    public static final String COUNTRY_ONE_CASE_PER_PEOPLE = "oneCasePerPeople";
    public static final String COUNTRY_ONE_DEATH_PER_PEOPLE = "oneDeathPerPeople";
    public static final String COUNTRY_ONE_TEST_PER_PEOPLE = "oneTestPerPeople";
    public static final String COUNTRY_POPULATION = "population";

    //US Data Constants
    public static final String US_STATE_NAME = "country";
    public static final String US_STATE_CONFIRMED = "cases";
    public static final String US_STATE_ACTIVE = "active";
    public static final String US_STATE_DECEASED = "deaths";
    public static final String US_STATE_NEW_CONFIRMED = "todayCases";
    public static final String US_STATE_TESTS = "tests";
    public static final String US_STATE_NEW_DECEASED = "todayDeaths";
    public static final String US_STATE_FLAGURL = "flag";
    public static final String US_STATE_RECOVERED = "recovered";
    public static final String US_STATE_CRITICAL = "critical";
    public static final String US_STATE_POPULATION = "population";
    public static final String US_STATE_DEATHS_PER_ONE_MILLION = "deathsPerOneMillion";
